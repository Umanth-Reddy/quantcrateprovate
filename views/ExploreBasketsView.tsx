...
const ExploreBasketCard: React.FC = () => (
    <GlassPane className="flex flex-col justify-between">
        <div className="p-6">
            <div className="flex items-start justify-between">
                <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-900/50 border border-gray-300 dark:border-cyan-400/30 flex items-center justify-center">
            ...
            <div className="grid grid-cols-4 gap-4 text-center mt-4 border-t border-b border-gray-200 dark:border-cyan-400/20 py-4">
                <div>
            ...
            <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-900/50 rounded-lg flex justify-between items-center border border-gray-200 dark:border-cyan-400/30">
                <div>
        ...
        <div className="bg-gray-50 dark:bg-black/30 p-4 flex justify-between items-center border-t border-gray-200 dark:border-cyan-400/20">
            <div className="flex items-center space-x-2">
                ...
                <span className="px-2 py-0.5 text-xs font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800/50 rounded-full border border-gray-300 dark:border-gray-600">Growth</span>
            </div>
            ...
            <GlassPane className="p-4 mb-6">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="relative flex-grow max-w-xs">
                        <input type="text" placeholder="Search Baskets..." className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-900/50 border border-gray-300 dark:border-cyan-400/30 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:focus:border-cyan-500 text-gray-900 dark:text-gray-100" />
