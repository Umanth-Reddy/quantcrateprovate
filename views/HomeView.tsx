...
const FeatureIcon: React.FC<{ variant: 'brain' | 'chart' | 'search' }> = ({ variant }) => {
    ...
    return <div className="w-16 h-16 rounded-full bg-gray-900/50 border border-cyan-400/20 flex items-center justify-center mb-4">{icons[variant]}</div>;
};
    ...
    return (
        <div className="flex-1 h-full w-full overflow-y-auto overflow-x-hidden">
            ...
            <section className="h-screen w-full flex flex-col items-center justify-center relative text-white text-center px-4">
                ...
                <div className="z-10 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-cyan-300">
                    ...
                    <button onClick={onNavigateToDashboard} className="bg-cyan-600 hover:bg-cyan-500 text-black font-bold py-3 px-8 rounded-lg transition-transform hover:scale-105 shadow-lg shadow-cyan-600/30">
                        Explore Dashboard
                    </button>
                </div>
            ...
            <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Why QuantCrate?</h2>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-100 dark:bg-black/20">
                <div className="max-w-6xl mx-auto">
                     <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-12 text-center">A Simple, Powerful Workflow</h2>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8">
                 <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Ready to Take Control?</h2>
