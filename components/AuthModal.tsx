            ...
            <GlassPane className="!border-cyan-400/50 dark:!shadow-cyan-500/30 p-8 max-w-md w-full relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                     ...
                     <div>
                        <AuthInput id="password" label="Password" type="password" required value={password} onChange={e => { setPassword(e.target.value); if(mode==='signup') checkPasswordStrength(e.target.value); }} />
