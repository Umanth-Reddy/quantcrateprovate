...
const GlassPane: React.FC<GlassPaneProps> = ({ children, className = '', hover = false, onClick }) => {
    const baseClasses = "bg-white dark:bg-black/30 rounded-lg border border-gray-200 dark:border-purple-400/20 shadow-lg dark:shadow-purple-500/10 transition-all duration-300";
